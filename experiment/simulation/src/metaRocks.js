...
var htm='<div class="row">'
			...
			+'</div>'
			+'<div class="col-sm-2">'
			+'<strong><center><span>Select metamorphic rocks</span></center></strong>'
			+'</div>'
			+'<div class="col-sm-7">'
			+'<select class="custom-select" id="mineral"  >'
			+'<option>------ Select metamorphic rock ------</option>'
	for(i=0;i<SampleRandomArr.length;i++){
			htm+='<option  value="'+ SampleRandomArr[i]+'">Metamorphic Rock '+ SampleRandomArr[i] +'</option>'
		}
		htm+='</select>'			
			+'</div>'
			+'</div>'
...
var thoery='<div class="container col-sm-12"  id="theory">'
	...
	+'</p>'
	+'<p><b>Metamorphic Rock</b><br>'
	+'The metamorphic rocks make up a large part of the Earths crust and are classified by texture and by chemical and mineral assemblage. '
	+'They may be formed simply by being deep beneath the Earths surface, subjected to high temperatures and the great pressure of the rock layers above it.'
	+'</p>'
	+'<p><b>Different Types of metamorphic rocks</b><br>'
	+'<ul><li><b>Foliated metamorphic rocks:</b> These rocks are produced by the exposure to heat and pressure which makes them appear layered. Phyllite, gneiss are examples of foliated metamorphic rocks'
	+' <li><b>Non-foliated metamorphic rocks:</b> These rocks dont have layers. Marble, quartzite are examples of non-foliated metamorphic rocks'
	+'</ul>'
	+'</p>'
	+'<p><b>Identification based on the various physical properties of metamorphic rocks are as follows </b><br>'
	+'<ul>'
	+'<li>Form '
	+'<li>Colour '
	+'<li>Fracture '
